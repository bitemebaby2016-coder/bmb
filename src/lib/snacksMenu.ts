...
export const SNACKS_MENU: HomeSnack[] = [
  {
    ...
    name: 'ปีซซามินิชีส',
    price: 49,
    description: 'แปห่นกรอบหน้าชีส์ละán เผในหม่ เบ่ขนาดคำเดียว',
    tag: 'ขายดี',
  ...
  },
  {
    ...
    name: 'เกียซาไ่',
    price: 55,
    description: 'เกียซาไ่หมoangหม่แ็นอบสด ชุ่ๆ กับซอสโผกระ',
    tag: 'สุดฟิน',
  ...
  },
  {
    ...
    name: 'ชิคเกนสตรिपส',
    price: 59,
    description: 'ชีคเกนเทนเดร์ทอด 6 ชิน กรอบย้ม กับซอสหมoang',
    tag: 'เฮลท์ตี้',
